...
namespace CtpKiosk
{
    ...
    public sealed partial class Border : Page
    {
        ...
        public Border()
        {
            ...
            selectedHeight = marking.Height;   // Initialize hight  of marking for croping
            selectedWidth = marking.Width;    // Initialize width of marking for croping
        }
        ...
        void target_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs e)
        {
            if (storeCropClick != null)
            {
                ...
                try
                {
                    var elementToTransform = (CompositeTransform)target.RenderTransform;
                    ...
                    // Condition for drang manipulaton of cropped image
                    switch (Convert.ToInt32(angle))
                    {
                        ...
                        //  elementToTransform.TranslateY = Boundary(elementToTransform.TranslateY - e.Delta.Translation.X, 200, -500);
                          break;
        ...
        private void cropClick(object sender, RoutedEventArgs e)
        {
            ...
            if (nextStatus != "")
            {
              ...
              //  Canvas.SetLeft(grdImageContainer, selectedLeft * -1);
                ...
                //grdImageContainer.Height = selectedHeight;
              //  grdImageContainer.Width = selectedWidth;
               //nextStatus = "Image cropped";
                marking.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
        ...
        /// <summary>
        /// This event move the textblock using touch gestures
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void btnRotate_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (nextStatus == "")
            {
                ...
                selectedHeight = marking.ActualHeight;
                selectedWidth = marking.ActualWidth;
            }
        ...
        private void marking_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs e)
        {
            ...
            try
            {
                ...
                imageHorizontalCenter = ((((int)target.Margin.Top + (int)target.ActualHeight) / 2) + (int)elementToTransform.TranslateY);
        ...
        /// <summary>
        /// This event used to drag the text curve
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// This event use to zoom plus printable area
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnZoomPlus_Click(object sender, RoutedEventArgs e)
        {
            if (marking.Width < 1000)
            {
                marking.Height += 50;
                marking.Width += 50;
                selectedHeight = marking.Height;
        ...
        /// <summary>
        /// This event use to zoom minus printable area
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnZoomMinus_Click(object sender, RoutedEventArgs e)
        {
            if (marking.Height > 100)
            {
                marking.Height -= 50;
                marking.Width -= 50;
                selectedHeight = marking.Height;
