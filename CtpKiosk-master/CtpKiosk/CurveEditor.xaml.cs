...
namespace CtpKiosk
{
    ...
    /// </summary>
    public sealed partial class CurveEditor : Page
    {
        public CurveEditor()
        {
      ...
      /*  private void DrawCurvedText(Windows.Graphics graphics, string text, Point centre, float distanceFromCentreToBaseOfText, float radiansToTextCentre, Font font, Brush brush)
        {
            //GraphicsPath fg = new GraphicsPath();
        ...
        private IEnumerable<float> GetCharacterWidths(Windows.Graphics graphics, string text, Font font)
        {
